...
def setup_chat_routes(
    ...
    async def chat_stream(request: Request) -> StreamingResponse:
        ...
        if _explicit_web_intent:
            ...
            # available even when the frontend toggle is stale/falsy. Keep
            # browser automation available too: search often finds a page that
            # then needs Playwright for inspection, form filling, or clicking.
        ...
        async def stream_with_save() -> AsyncGenerator[str, None]:
            ...
            if image_generation_session:
                ...
                try:
                    ...
                    _forced_tools = None
                    if _explicit_web_intent:
                        _forced_tools = {"web_search", "web_fetch"} | set(_BROWSER_MCP_TOOLS)
